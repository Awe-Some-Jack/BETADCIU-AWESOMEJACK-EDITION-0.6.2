function onCreate()
	-- background shit
	makeLuaSprite('limoSunset2', 'limoholo/limoNight', -120, -50);
	...
	makeAnimatedLuaSprite('limoDancer2', 'limoholo/limoOfficer',550, 100);
    setLuaSpriteScrollFactor('limoDancer2', 0.4, 0.4);

	makeAnimatedLuaSprite('limoDancer3', 'limoholo/limoOfficer',250, 100);
    setLuaSpriteScrollFactor('limoDancer3', 0.4, 0.4);
	
	makeAnimatedLuaSprite('limoDancer4', 'limoholo/limoOfficer',850, 100);
    setLuaSpriteScrollFactor('limoDancer4', 0.4, 0.4);
	
	makeAnimatedLuaSprite('limoDancer5', 'limoholo/limoOfficer',1150, 100);
	...
	addAnimationByPrefix('limoDancer2', 'idle', 'bg dancer sketch PINK officer', 24, true); 
	addLuaSprite('limoDancer3', false);
	addAnimationByPrefix('limoDancer3', 'idle', 'bg dancer sketch PINK officer', 24, true);
	addLuaSprite('limoDancer4', false);
	addAnimationByPrefix('limoDancer4', 'idle', 'bg dancer sketch PINK officer', 24, true);
	addLuaSprite('limoDancer5', false);
	addAnimationByPrefix('limoDancer5', 'idle', 'bg dancer sketch PINK officer', 24, true);
